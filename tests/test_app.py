...
from app import app, translate_and_phoneticize, translate_to_korean_and_phoneticize, audio_tts
...
class TestApp(unittest.TestCase):
    ...
    def test_translate_to_korean_and_phoneticize(self, mock_create):
        ...
        translation, segments, phonetic_texts = translate_to_korean_and_phoneticize("Hello")
